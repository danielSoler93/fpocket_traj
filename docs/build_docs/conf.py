...
latex_documents = [
    (master_doc, 'fpocket_traj.tex', 'fpocket_traj documentation',
...
man_pages = [
(master_doc, 'fpocket_traj', 'fpocket_traj documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fpocket_traj', 'fpocket_traj documentation',
     author, 'fpocket_traj', 'fpocket along MD trajectories',
     'Miscellaneous'),
]
